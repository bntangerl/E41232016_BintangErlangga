      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row gy-4 align-items-center justify-content-between">
          ...
          <div class="col-xl-5" data-aos="fade-up" data-aos-delay="200">
            <span class="about-meta">Hai nama saya, Bintang Erlangga</span>
            <h2 class="about-title">Jurusan TIF, Prodi Teknik Informatika</h2>
            <p class="about-description">Pagiku Cerahku, Matahari Bersinar</p>
